       ...
       String endpoint = String.format("%s?IP_Balanza=%s&Status=%s&LastUpdate=%s&UserUpdate=%s",
        ...
        try{
            ...
            if(response.getStatusCode() == HttpStatus.OK){
                logger.info("Se ha modificado el log correctamente para balanza {}.",log.getIpBalanza());
            }else {
                logger.error("Error al actualizar la ultima fecha y hora para balanza {}.", log.getIpBalanza());
            }
